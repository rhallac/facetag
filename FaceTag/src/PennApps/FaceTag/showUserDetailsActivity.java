...
import PennApps.FaceTag.facebook.FacebookRequestError;
import PennApps.FaceTag.facebook.Request;
import PennApps.FaceTag.facebook.Response;
import PennApps.FaceTag.facebook.Session;
import com.facebook.model.GraphUser;
import com.facebook.widget.ProfilePictureView;
import com.parse.ParseFacebookUtils;
import com.parse.ParseUser;

public class showUserDetailsActivity extends Activity {
	...
	private void updateViewsWithProfileInfo() {
		...
		if (currentUser.get("profile") != null) {
			...
			try {
				...
				Log.d("nope", "Error parsing saved user data.");
			}
